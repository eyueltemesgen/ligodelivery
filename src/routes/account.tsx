...
export const Route = createFileRoute("/account")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Manage your Ligo profile, phone number and delivery details." },
...
function AccountPage() {
  const { user, profile, refresh, loading, isAdmin, isRider } = useAuth();
  ...
  return (
    <div className="container-ligo max-w-2xl py-10">
      ...
      <form onSubmit={save} className="mt-6 space-y-4 rounded-xl border border-border bg-card p-6 shadow-card">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        ...
        {isRider && <Button asChild variant="outline"><Link to="/rider">Rider portal</Link></Button>}
